...
@NamedQuery(name="checkdupl",query = "Select count(entity) from ApplicationEntity entity " + " where entity.userId=:userId OR entity.email=:userEmail OR entity.mobile=:userMobile ")
