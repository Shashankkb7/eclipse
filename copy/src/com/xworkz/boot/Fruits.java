...
public class Fruits {
	...
	public Fruits(boolean type,String flavour,String texture,int watercontent,int carbohydrates,String[] size,String[] ingredients,String[] shape,String[] name,String[] color,double[] price) {
		...
		this.color=color;
		this.price=price;
		System.out.println("fruits construtor with 11 argument");
	}
		public void display() {
